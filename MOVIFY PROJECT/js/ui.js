    ...
    showMovies(data) {
      ...
      <div class="card medium black">
        ...
        <div class="card-content black">
          <span class="card-title activator white-text text-darken-4">${results.Title}</span> <i class="material-icons right">more_vert</i>
        </div>
       <div class="card-reveal black">
        <span class="card-title activator white-text text-darken-4">${results.Title}</span> <i
          ...
          <a href="#" class="waves-effect waves-light green btn-small" onclick="movieClicked('${results.imdbID}')">More Info...</a>
       </div>
      </div>
        ...
        <div class="card-stacked black">
          <div class="card-content black">
            ...
            <div class="card-action">
              <a href="https://www.imdb.com/title/${info.imbdID}" target="_blank">Watch on IMDB</a>
